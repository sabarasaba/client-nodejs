(function() {
	...
	RestHandlers.prototype.listItems = function(object, params, callback) {
		...
		req.on('complete', function(data, res) {
			that.genericResponse('GET', object, data, callback, req, res);
		});
	...
	RestHandlers.prototype.addItem = function(object, params, callback) {
		...
		req.on('complete', function(data, res) {
			that.genericResponse('POST', object, data, callback, req, res);
		});
	...
	RestHandlers.prototype.editItem = function(itemId, object, params, callback) {
		...
		req.on('complete', function(data, res) {
			that.genericResponse('PUT', object, data, callback, req, res);
		});
	...
	RestHandlers.prototype.removeItem = function(itemId, object, params, callback) {
		...
		req.on('complete', function(data, res) {
			that.genericResponse('DELETE', object, data, (_.isFunction(params) ? params : callback), req, res);
		});
	...
	RestHandlers.prototype.getCapturedRequests = function() {
		return rest.getCapturedRequests();
	};
